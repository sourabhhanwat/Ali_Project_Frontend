      ...
      <Image style={styles.image} src="/logo.jpg"/>
       {props.data
          ...
          <> 
            ...
            <Text style={styles.text}>Brace/Legs</Text>
            <Text style={styles.text}>Grouted Piles</Text>
            <Text style={styles.text}>Shallow Gas Loop                    {props.data.shallow_gas_score}</Text>
            
            <Text style={styles.text}>Condition Score</Text>
            <Text style={styles.text}>Last Inspection</Text>
            ...
            <Text style={styles.text}>Unprotected Appurtenances</Text>
            
            <Text style={styles.text}>Loading Score                   {props.data.loading_score}</Text>
            <Text style={styles.text}>Deck Load</Text>
            <Text style={styles.text}>Deck Elevation - Wave in Deck </Text>
            <Text style={styles.text}>Additional Appurtenances</Text>
            <Text style={styles.text}>Fatigue Load</Text>
