...
=======
                            <Typography style={{color: "white", fontWeight: 'bold', textAlign:"center", fontSize: "25px" ,padding:"0.4rem 1rem"}}>{risk_ranking}</Typography>
>>>>>>> be6cc6d0dd590a143162846e1bcc53d27edf997d
                        </div>
                    </Grid>
