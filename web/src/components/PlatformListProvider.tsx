...
export const PlatformSchema = yup
    .object({
        ...
        economic_consequence_category:yup.string(),
        risk_ranking:yup.string(),
        environmental_consequence_category:yup.string(),
        ...
        level_1_last_inspection_date:yup.string(),
        level_2_last_inspection_date:yup.string(),
        level_3_last_inspection_date:yup.string(),
        level_1_next_inspection_date:yup.string(),
        level_2_next_inspection_date:yup.string(),
        level_3_next_inspection_date:yup.string(),
        // next_10_years_inspection_plan: 
        // yup.object().shape({
