...
export const PlatformSchema = yup
    .object({
        ...
        economic_consequence_category:yup.string().matches(/^[A-E]*$/, 'Only character A-E').typeError('Only character A-E'),
        risk_ranking:yup.string(),
        environmental_consequence_category:yup.string().matches(/^[A-E]*$/, 'Only character A-E').typeError('Only character A-E'),
